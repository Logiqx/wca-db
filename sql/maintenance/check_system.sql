...
SHOW VARIABLES LIKE 'secure_file_priv'; -- NULL -> /home/jovyan/work/
...
SELECT @@innodb_log_buffer_size / 1024 / 1024;  -- 8 MB
...
-- InnoDB Temp Tables - Note that this command in itself creates a temporary table
